...
- A: [Installation](https://github.com/Tropixi/nitro-sniper/wiki/Installation)

<br />

- **Q: Where can I find the default configuration?**
- A: [Default Configuration](https://github.com/Tropixi/nitro-sniper/wiki/Default-Configuration)
